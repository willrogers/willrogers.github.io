...
EPICS servers are called input/output controllers or _IOCs_, for reasons that may
or may not make sense. Each IOC provides a number of process variables or _PVs_. A PV
...
_Channel Access_. There are a number of parts to the protocol:
